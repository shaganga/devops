   ...
   stage('Stage: upload to jfrog') {
    ...
    stage('Stage: Deploy into web/app server') {
        ...
        remote.allowAnyHosts = true
			...
			sshCommand remote: remote, command: "curl -u $jfrog_user:$jfrog_pwd -X  -C GET https://veeshadevops.jfrog.io/artifactory/mvn-repo/$BUILD_NUMBER/hello-world-0.1.0.jar"
		}
            }
        }
    }
